...
class Candidate(models.Model):
    ...
    resume_name = models.CharField(max_length=255, blank=True, help_text='ชื่อไฟล์ resume')
    resume_sharepoint_url = models.URLField(blank=True, help_text='SharePoint URL ของ resume — เข้าได้เฉพาะ HR/Admin')
